<?php
    ...
    // Usage: [custom_breadcrumbs taxonomy="your-taxonomy" dark-mode="true"]
    add_shortcode('custom_breadcrumbs', function ($atts) {
        ...
        $isDarkMode = $atts['dark-mode'] == "true";
    ...
    // Usage: [custom_archive_breadcrumbs post-type="your-post-type" taxonomy="your-taxonomy" dark-mode="true"]
    add_shortcode('custom_archive_breadcrumbs', function ($atts) {
        ...
        if (is_tax()) {
            ...
            if ($term instanceof WP_Term && $term->taxonomy === $taxonomy) {
                ...
                // Add the home link
                $breadcrumbs .= '<a href="' . $archive_link . '">Templates</a>';
                $breadcrumbs .= $divider;
